...
public class LoginController implements Initializable {
    ...
    public static final String IDLE_BUTTON_STYLE = "-fx-background-color: #97FFFF; ";
    public static final String HOVERED_BUTTON_STYLE = "-fx-background-color: #528B8B; ";
        ...
        try {
            ...
            if (validate(tf_username.getText()) || !pf_password.getText().equals("")) {
                ...
                if (Memory.messenger.equalsIgnoreCase("valid user")) {
                    ...
                    FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("HomeView.fxml"));
        ...
        if (!toogleGroupValue.isBlank() && isInputValidate() ) {
            if (validate(dk_username.getText())) {
                if (dk_pass.getText().equals(dk_retype.getText())) {
                    ...
                    try {
                        FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("Alert.fxml"));
