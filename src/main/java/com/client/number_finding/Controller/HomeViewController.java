package com.client.number_finding.Controller;

import com.client.number_finding.LoginView;
import com.server.number_finding.Memory;
...
public class HomeViewController implements Initializable {
    ...
    private static final String IDLE_BUTTON_STYLE = "-fx-background-color: #97FFFF; ";
    private static final String HOVERED_BUTTON_STYLE = "-fx-background-color: #528B8B; ";
    Timer timer;
    ...
    public void setBtn_practiceOnclick(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("PracticeStage.fxml"));
            ...
            public void run() {
                Platform.runLater(() -> {
                    ...
                    if (arr[0].equals("RankingData")) {
                        timer123.cancel();
                        try {
                            FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("testRank.fxml"));
...
//                            listRank.display();
    ...
    public void setBtn_accountOnClick(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("EditAccount.fxml"));
            Parent parent = fxmlLoader.load();
            Stage stage = new Stage();
            stage.setScene(new Scene(parent));
            stage.setResizable(false);
            ...
            public void run() {
                Platform.runLater(() -> {
                    if (checkLobby(Memory.messenger)) {
                        ...
                        try {
                            FXMLLoader fxmlLoader = new FXMLLoader(LoginView.class.getResource("Multiplayer.fxml"));
                            Parent parent = fxmlLoader.load();
                            Stage stage = new Stage();
                            stage.setScene(new Scene(parent));
                            stage.setResizable(false);
