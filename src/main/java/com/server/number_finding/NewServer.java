...
import com.server.controller.BUS.DetailMatchBUS;
import com.server.controller.BUS.Match;
import com.server.controller.BUS.UserAccountBUS;
import com.server.model.DTO.DetailMatchDTO;
import com.server.model.DTO.NumberPoint;
...
public class NewServer implements Runnable {
    ...
    public NewServer() {
        try {
            ...
            serverSocket = new ServerSocket(2003, 0, InetAddress.getByName("192.168.160.1"));
            // khởi tạo
            ListLobby = new ArrayList<>();
            accountBus = new UserAccountBUS();
            detailMatchBUS = new DetailMatchBUS();
            System.out.println("Server started on address " + serverSocket.getInetAddress().getHostAddress() + " and port " + serverSocket.getLocalPort() + "...");
                ...
                switch (lenght) {
                    ...
                    case 6:
                        ...
                        if (job[0].equalsIgnoreCase("SIGNUP")) {
                            ...
                            dtotmp.setStrGender("giới tính :"+job[4]);
                            dtotmp.setStrDayOfBirth("ngày sinh :" +job[5]);
                            //todo valid user
